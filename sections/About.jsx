...
const About = () => (
  <section className={`${styles.paddings} relative z-10`}>
    ...
    >
        ...
        >
          <span className='font-extrabold text-purple-500'>Metaverse </span>
           ...
           Let's <span className='font-extrabold text-purple-500'> explore </span> the madness of the metaverse by scrolling down
        </motion.p>
        <motion.img 
